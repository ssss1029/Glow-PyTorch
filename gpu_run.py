...
class Config:
    ...
    JOBS = {
        "glow1" : "python3 train.py --download --dataroot=/data/sauravkadavath/cifar10-dataset/ --fresh --output_dir=/data/sauravkadavath/Glow-PyTorch/snapshots/output_1",
        "glow2" : "python3 train.py --download --dataroot=/data/sauravkadavath/cifar10-dataset/ --fresh --output_dir=/data/sauravkadavath/Glow-PyTorch/snapshots/output_2",
        "glow3" : "python3 train.py --download --dataroot=/data/sauravkadavath/cifar10-dataset/ --fresh --output_dir=/data/sauravkadavath/Glow-PyTorch/snapshots/output_3",
        "glow4" : "python3 train.py --download --dataroot=/data/sauravkadavath/cifar10-dataset/ --fresh --output_dir=/data/sauravkadavath/Glow-PyTorch/snapshots/output_4",
        "glow5" : "python3 train.py --download --dataroot=/data/sauravkadavath/cifar10-dataset/ --fresh --output_dir=/data/sauravkadavath/Glow-PyTorch/snapshots/output_5",
        "glow6" : "python3 train.py --download --dataroot=/data/sauravkadavath/cifar10-dataset/ --fresh --output_dir=/data/sauravkadavath/Glow-PyTorch/snapshots/output_6",
    }
